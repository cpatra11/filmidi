...
struct MomentDragTests {
    ...
    @Test func malformedSegmentsRejected() {
        #expect(MediaTab.assetSegment(fromDragString: "filmidi-asset://x#5-2") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "filmidi-asset://x#-1-2") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "filmidi-asset://x#junk") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "filmidi-folder://x#1-2") == nil)
        #expect(MediaTab.assetId(fromDragString: "filmidi-asset://x#junk") == "x")
    }
