...
<a href="https://github.com/filmidi-io/filmidi-pro/releases/latest/download/FilmidiPro.dmg">
  <img src="../../assets/macos-badge.png" alt="下載 macOS 版 Filmidi Pro" width="180" />
</a>

<sub><i>需要搭載 Apple Silicon 的 macOS 26 (Tahoe)</i></sub>

<a href="https://x.com/Filmidi_io"><img src="https://img.shields.io/badge/Follow-%40Filmidi__io-000000?style=flat&logo=x&logoColor=white" alt="在 X 上追蹤" /></a>
...
<img src="../../assets/filmidi-ui.png" alt="Filmidi Pro 介面" width="900" />

---

Filmidi Pro 是 Mac 的開源影片剪輯器。你和你的 agent 可以在時間軸中一起生成和剪輯影片。

### Swift 原生影片剪輯器

我們用 Swift 從零打造 Filmidi Pro。參考目標是 Premiere Pro，並以我們自己的方式把 AI 融入工作流程。
...
- **Twitter / X:** 追蹤 **[@Filmidi_io](https://x.com/Filmidi_io)** 取得更新和公告。
- **Instagram:** 追蹤 [@filmidi.io](https://www.instagram.com/filmidi.io)。
- **回饋與支援:** 建立 [GitHub Issue](https://github.com/filmidi-io/filmidi-pro/issues) 或寄信到 founders@filmidi.io。
...
<a href="https://www.star-history.com/?type=date&repos=filmidi-io%2Ffilmidi-pro">
 <picture>
   ...
   <img alt="Star History 圖表" src="https://api.star-history.com/chart?repos=filmidi-io/filmidi-pro&type=date&legend=top-left" />
 </picture>
</a>
...
Filmidi Pro 基於 [GPLv3](../../LICENSE) 開源。
