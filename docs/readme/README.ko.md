...
<a href="https://github.com/filmidi-io/filmidi-pro/releases/latest/download/FilmidiPro.dmg">
  <img src="../../assets/macos-badge.png" alt="macOS용 Filmidi Pro 다운로드" width="180" />
</a>

<sub><i>Apple Silicon 기반 macOS 26 (Tahoe) 필요</i></sub>

<a href="https://x.com/Filmidi_io"><img src="https://img.shields.io/badge/Follow-%40Filmidi__io-000000?style=flat&logo=x&logoColor=white" alt="X에서 팔로우" /></a>
...
Filmidi Pro는 Mac용 오픈 소스 비디오 편집기입니다. 사용자와 agent가 타임라인 안에서 함께 비디오를 생성하고 편집할 수 있습니다.

### Swift 네이티브 비디오 편집기

Filmidi Pro는 Swift로 처음부터 만들었습니다. 기준은 Premiere Pro이며, AI를 워크플로에 통합하는 Filmidi Pro만의 방식을 적용했습니다.
...
- **Twitter / X:** 업데이트와 공지는 **[@Filmidi_io](https://x.com/Filmidi_io)**를 팔로우하세요.
- **Instagram:** [@filmidi.io](https://www.instagram.com/filmidi.io)를 팔로우하세요.
- **피드백 및 지원:** [GitHub Issue](https://github.com/filmidi-io/filmidi-pro/issues)를 만들거나 founders@filmidi.io로 이메일을 보내세요.
...
Filmidi Pro는 [GPLv3](../../LICENSE)에 따라 오픈 소스로 제공됩니다.
