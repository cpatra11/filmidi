...
final class SampleProjectService {
    ...
    private var baseURL: URL? { BackendConfig.httpURL }
    ...
    /// Builds a new `.filmidi` package for `slug` and returns its URL. Reports
    ...
    private static func cacheRoot() -> URL {
        ...
        return base.appendingPathComponent("FilmidiPro/Samples", isDirectory: true)
    }
