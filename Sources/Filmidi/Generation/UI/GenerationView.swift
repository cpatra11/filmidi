...
struct GenerationView: View {
    ...
    @AppStorage("generationPromptExtra") var promptExtra: Double = 0
    @State var liveExtra: Double?
    @State var dragStartExtra: Double?
    @State var measuredPanelHeight: CGFloat = 0
    @State var measuredPromptHeight: CGFloat = 0
    ...
    var catalogLoadingView: some View {
