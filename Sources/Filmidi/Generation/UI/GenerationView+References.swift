...
extension GenerationView {
    ...
    var allRefCardItems: [(asset: MediaAsset, tag: String, type: ClipType)] {
    ...
    func addRefAsset(_ asset: MediaAsset) {
    ...
    func removeRef(_ type: ClipType, byId id: MediaAsset.ID) {
        switch type {
