    ...
    private var sections: [Section] {
        ...
        return [
            Section(id: "chat", title: "Chat (Agent)",
                    rows: prepare(catalog.chat.map { Row(id: $0.id, displayName: $0.displayName, paidOnly: $0.paidOnly) })),
            ...
            Section(id: "transcription", title: "Transcription",
                    rows: prepare(catalog.transcription.map { Row(id: $0.id, displayName: $0.displayName, paidOnly: $0.paidOnly) })),
